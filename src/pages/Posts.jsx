    ...
    <div className="bg-emerald-300/[.2]  py-5 sm:py-10 ">
      ...
      {posts && posts.length && (
        <div className="flex-column relative mt-10 flex h-[18rem] justify-evenly md:h-[24rem] md:flex-row">
          <div>
            <div className="... absolute left-1/4 top-1/2 -translate-x-1/2 -translate-y-1/2 truncate text-3xl font-semibold underline decoration-teal-600 decoration-4">
              您的每日推薦
            </div>
          </div>
            ...
            <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
              <div className="absolute inset-0">
                <img
                  ...
                  src="https://source.unsplash.com/J4itE356ie0"
                />
              </div>
          ...
          posts.map((post) => (
            <a key={post.id} href={`/posts/${post.id}`}>
              ...
              >
                <img
                  alt=""
                  className="w-12/12  rounded-lg grayscale-[35%]"
                ...
                <div className="relative h-full">
                  <div className="align-center  mt-4 flex-col justify-between">
                    ...
                    <div className="mt-2 justify-self-end text-center text-sm italic">
                      {post.kind}
                    </div>
                  </div>
                  ...
                  <div className="absolute top-1/2 flex h-3/6 w-full justify-center px-4 text-gray-700">
                    <span className="text-center text-sm font-black md:text-xl">
                      {post.content}
                    </span>
                  </div>
                  <div className="absolute bottom-0 flex flex-row">
                    <svg
                      aria-hidden="true"
                      className="h-6 w-6 stroke-2 text-teal-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
